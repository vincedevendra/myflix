...
describe Category do
  ...
  describe "#recent_videos" do
    it "should return all videos in the category if there's less than 6." do
    ...
    it "should return all videos in the cat. if there are less than 6, in order, beginning with the most recently created." do
      comedies = Category.create(title: "Comedies")
    ...
    it "should return the six most recently created videos in a category if there are more than six, beginning with most recently created." do
      comedies = Category.create(title: "Comedies")
    ...
    it "should return a blank array if a category has no videos" do
      comedies = Category.create(title: "Comedies")
